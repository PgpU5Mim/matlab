...
for j=1:1:channel_num
    ...
    txt = {['mu=' num2str(pd.mu) 'V'],['sigma=' num2str(pd.sigma*1e3) 'mV'],['max=' num2str(max(x_values)) 'V'],['min=' num2str(min(x_values)) 'V'],['delta=' num2str(yield_delta(cell_i)*1000) 'mV'],['yield=' num2str(yield(j)*100) '%']};
