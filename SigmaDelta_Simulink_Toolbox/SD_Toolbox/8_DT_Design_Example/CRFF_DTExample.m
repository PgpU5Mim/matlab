...
%           CRFF-DT design example model. Similar to load_par.
...
target_mod = 'mod3_CRFF_DTExample';      % Reference model for sweep routines.
%% MODULATOR VARIABLES:

fb = 24e3;                 % Converter bandwidth - Audio(0Hz - 24KHz) - in Hz
OSR = 128;                 % Oversampling ratio used to define singal band 
